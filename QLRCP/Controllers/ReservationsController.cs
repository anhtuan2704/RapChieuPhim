...
namespace QLRCP.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        {
            var reservations = db.Reservations.Include(r => r.Customer).Include(r => r.Seat).Include(r => r.Show);
        ...
        {
            ViewBag.CustomerID = new SelectList(db.ApplicationUsers, "Id", "Name");
        ...
        public ActionResult Create([Bind(Include = "Id,CustomerID,SeatID,ShowID")] Reservation reservation)
        {
            ...
            ViewBag.CustomerID = new SelectList(db.ApplicationUsers, "Id", "Name", reservation.CustomerID);
